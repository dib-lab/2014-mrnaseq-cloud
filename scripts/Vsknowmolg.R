...
p_mapped_frame<-data.frame(Sample= c("Raw Trinity", "DN Trinity","Raw Oases","DN Oases",
                                     "Raw Trinity", "DN Trinity","Raw Oases","DN Oases",
                                     "Raw Trinity", "DN Trinity","Raw Oases","DN Oases"),
